...
const DirectorySubmissionSites = () => {
  ...
  return (
    <div style={{ textAlign: 'center', padding: '30px', background: 'linear-gradient(135deg, #f0fff0 0%, #d0ffd0 100%)', minHeight: '100vh' }}>
      <h1 style={{ color: '#228b22', marginBottom: 10 }}>Top Directory Submission Sites</h1>
