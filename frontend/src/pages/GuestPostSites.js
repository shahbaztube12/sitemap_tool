...
const GuestPostSites = () => {
  ...
  return (
    <div style={{ textAlign: 'center', padding: '30px', background: 'linear-gradient(135deg, #fff0f5 0%, #ffe6f0 100%)', minHeight: '100vh' }}>
      <h1 style={{ color: '#b30059', marginBottom: 10 }}>Top Guest Post Sites</h1>
