      ...
      <div className="seo-services-delhi">
        <main className="seo-main-content">
          <section className="section hero-section">
            <h1>🚀 Top-Rated SEO Services in Janakpuri to Boost Your Business</h1>
            <p>
              Maximize your online visibility with our expert SEO services tailored for businesses in Janakpuri.<br />
          ...
          <section className="section result-driven">
            <h2>{icon.result} Result-Driven SEO Services in Janakpuri</h2>
            <ul>
          ...
          <section className="section about-company">
            <h2>{icon.happy} CyberWorx Technologies: The #1 Best SEO Company in Janakpuri</h2>
            <p>
          ...
          <section className="section location">
            <h2>{icon.office} Contact Our SEO Experts in Janakpuri</h2>
            <p>Visit our office or call us to schedule your free consultation.</p>
          </section>

          <section className="section contact-form">
            <h3>{icon.expert} Ready to Elevate Your Janakpuri Business with SEO?</h3>
          ...
          <footer className="section internal-links">
            <p>
              Explore More:
              <a href="/local-seo-janakpuri">{icon.local} Local SEO Janakpuri</a> |
...
export default SeoCompanyJanakpuri;
