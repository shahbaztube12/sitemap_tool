...
const AdPostList = () => {
  ...
  return (
    <div style={{ textAlign: 'center', padding: '30px', background: 'linear-gradient(135deg, #f8faff 0%, #e3e9f7 100%)', minHeight: '100vh' }}>
      <h1 style={{ color: '#007bff', marginBottom: 10 }}>Top 100 Free Ad Posting Sites</h1>
